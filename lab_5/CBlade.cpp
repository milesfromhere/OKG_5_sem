...
// CBlade.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCBladeApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CCBladeApp::OnAppAbout)
...
CCBladeApp::CCBladeApp() noexcept
{
	...
	SetAppID(_T("CBlade.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CCBladeApp

CCBladeApp theApp;


// Инициализация CCBladeApp

BOOL CCBladeApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCBladeDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CCBladeView));
	if (!pDocTemplate)
		return FALSE;
	...
	m_pMainWnd->SetWindowText(_T("Blade"));
...
// Обработчики сообщений CCBladeApp
