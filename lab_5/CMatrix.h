...
public:
	...
	CMatrix GetRow(int, int, int);			// Возвращает подстроку из строки по номеру	 
	CMatrix GetCol(int);					// Возвращает столбец по номеру
	CMatrix GetCol(int, int, int);			// Возвращает подстолбец из столбца по номеру
	...
	CMatrix RedimData(int);					// Изменяет размер матрицы с сохранением данных, которые можно сохранить
